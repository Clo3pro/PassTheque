    ...
    <body>
        ...
        <table id='tableau_admin'>
            ...
            <tr id= "ligne_table">
                ...
                <td id="case_table"><input type="button"  id="modifier" name="modify" value="Modifier" method="GET" action="modifier.php?id=<?=$donnees['isbn']?>"></input>
                <input type="submit" name="delete" id="supprimer" value="Supprimer" method="GET" onsubmit="return areYouSure()"></input>
                </td>
            </tr>
